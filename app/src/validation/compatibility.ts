...
export class CompatibilityReporter {
   ...
   */
  static generateCompatibilityReport(request: ChatCompletionRequest): CompatibilityReport {
   ...
   */
  static analyzeRequest(request: ChatCompletionRequest): CompatibilityReport {
   ...
   */
  static getClaudeSDKOptions(request: ChatCompletionRequest): Record<string, any> {
   ...
   */
  static hasUnsupportedParameters(request: ChatCompletionRequest): boolean {
    return (
   ...
   */
  static getUnsupportedParameterNames(request: ChatCompletionRequest): string[] {
    const report = this.generateCompatibilityReport(request);
