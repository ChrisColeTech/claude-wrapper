...
exports.VALIDATION_FRAMEWORK_ERRORS = exports.VALIDATION_FRAMEWORK_MESSAGES = exports.VALIDATION_FRAMEWORK_CACHE_KEYS = exports.VALIDATION_FRAMEWORK_LIMITS = exports.TOOL_MESSAGE_VALIDATION = exports.MESSAGE_PROCESSING_ERRORS = exports.MESSAGE_PROCESSING_MESSAGES = exports.MESSAGE_PROCESSING_LIMITS = exports.MESSAGE_TYPES = exports.MESSAGE_ROLES = void 0;
/**
...
exports.MESSAGE_PROCESSING_LIMITS = {
...
exports.MESSAGE_PROCESSING_MESSAGES = {
    ...
    PROCESSING_TIMEOUT: "Message processing exceeded ".concat(exports.MESSAGE_PROCESSING_LIMITS.PROCESSING_TIMEOUT_MS, "ms timeout"),
    CORRELATION_TIMEOUT: "Correlation processing exceeded ".concat(exports.MESSAGE_PROCESSING_LIMITS.CORRELATION_TIMEOUT_MS, "ms timeout"),
    RESULT_TIMEOUT: "Result handling exceeded ".concat(exports.MESSAGE_PROCESSING_LIMITS.RESULT_HANDLING_TIMEOUT_MS, "ms timeout"),
...
exports.MESSAGE_PROCESSING_ERRORS = {
...
exports.VALIDATION_FRAMEWORK_LIMITS = {
    ...
    VALIDATION_METRICS_RETENTION_MS: 600000
};
exports.VALIDATION_FRAMEWORK_CACHE_KEYS = {
...
exports.VALIDATION_FRAMEWORK_MESSAGES = {
    FRAMEWORK_VALIDATION_TIMEOUT: "Validation framework exceeded ".concat(exports.VALIDATION_FRAMEWORK_LIMITS.VALIDATION_TIMEOUT_MS, "ms timeout"),
    CUSTOM_RULE_REGISTRATION_FAILED: "Custom validation rule registration failed",
    CACHE_OVERFLOW: "Validation cache overflow detected (max ".concat(exports.VALIDATION_FRAMEWORK_LIMITS.VALIDATION_CACHE_SIZE, ")"),
    ...
    CONCURRENT_VALIDATION_LIMIT_EXCEEDED: "Concurrent validation limit exceeded (".concat(exports.VALIDATION_FRAMEWORK_LIMITS.MAX_CONCURRENT_VALIDATIONS, ")"),
    SCHEMA_COMPLEXITY_EXCEEDED: "Schema complexity exceeded maximum score (".concat(exports.VALIDATION_FRAMEWORK_LIMITS.SCHEMA_COMPLEXITY_MAX_SCORE, ")"),
    PARAMETER_DEPTH_EXCEEDED: "Parameter validation depth exceeded (".concat(exports.VALIDATION_FRAMEWORK_LIMITS.PARAMETER_VALIDATION_MAX_DEPTH, ")"),
    CUSTOM_RULES_LIMIT_EXCEEDED: "Custom rules limit exceeded (".concat(exports.VALIDATION_FRAMEWORK_LIMITS.CUSTOM_RULES_MAX_COUNT, ")"),
    RETRY_LIMIT_EXCEEDED: "Runtime validation retry limit exceeded (".concat(exports.VALIDATION_FRAMEWORK_LIMITS.RUNTIME_VALIDATION_RETRY_COUNT, ")"),
...
exports.VALIDATION_FRAMEWORK_ERRORS = {
    TIMEOUT: "TIMEOUT",
