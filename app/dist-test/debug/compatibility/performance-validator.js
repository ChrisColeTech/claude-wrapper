...
var logger = (0, logger_1.getLogger)('PerformanceValidator');
/**
 * Performance validator
 * SRP: Performance analysis operations only
 */
var PerformanceValidator = /** @class */ (function () {
    function PerformanceValidator() {
    }
    /**
     * Analyze performance for a specific tool call
     */
    PerformanceValidator.prototype.analyzePerformance = function (sessionId, toolCallId) {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, metrics, score, bottlenecks, optimizations, meetsBenchmarks, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, this.collectPerformanceMetrics(sessionId, toolCallId)];
                    case 2:
                        metrics = _a.sent();
                    ...
                    case 3:
                        bottlenecks = _a.sent();
                        optimizations = this.generateOptimizations(metrics, bottlenecks);
     ...
     */
    PerformanceValidator.prototype.measureExecutionTime = function (operation) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    PerformanceValidator.prototype.trackMemoryUsage = function (sessionId) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    PerformanceValidator.prototype.generatePerformanceReport = function (metrics) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    PerformanceValidator.prototype.identifyBottlenecks = function (metrics) {
        return __awaiter(this, void 0, void 0, function () {
            var bottlenecks;
            return __generator(this, function (_a) {
                bottlenecks = [];
                ...
                if (metrics.executionTimeMs > constants_1.DEBUG_PERFORMANCE_LIMITS.SLOW_EXECUTION_THRESHOLD_MS) {
                    bottlenecks.push("Slow execution time: ".concat(metrics.executionTimeMs, "ms (threshold: ").concat(constants_1.DEBUG_PERFORMANCE_LIMITS.SLOW_EXECUTION_THRESHOLD_MS, "ms)"));
                }
                ...
                if (metrics.networkTimeMs && metrics.networkTimeMs > 200) { // 200ms threshold for network
                    bottlenecks.push("Slow network operations: ".concat(metrics.networkTimeMs, "ms"));
                }
     ...
     */
    PerformanceValidator.prototype.collectPerformanceMetrics = function (sessionId, toolCallId) {
        return __awaiter(this, void 0, void 0, function () {
            var currentMemory;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    PerformanceValidator.prototype.calculatePerformanceScore = function (metrics) {
     ...
     */
    PerformanceValidator.prototype.generateOptimizations = function (metrics, bottlenecks) {
        var optimizations = [];
        if (metrics.executionTimeMs > constants_1.DEBUG_PERFORMANCE_LIMITS.SLOW_EXECUTION_THRESHOLD_MS) {
     ...
     */
    PerformanceValidator.prototype.checkBenchmarkCompliance = function (metrics) {
     ...
     */
    PerformanceValidator.prototype.calculateAverage = function (numbers) {
        if (numbers.length === 0)
            return 0;
