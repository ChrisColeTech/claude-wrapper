 ...
 */
function initializeAuthentication(logger) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, auth_manager_1.authManager.detectAuthMethod()];
                case 1:
                    authResult = _a.sent();
                    if (authResult.valid) {
                        console.log("\uD83D\uDD10 Claude authentication: ".concat(authResult.method));
                        logger.info("Authentication method detected: ".concat(authResult.method));
                    }
                    else {
                ...
                case 2:
                    error_1 = _a.sent();
                    logger.debug("Authentication initialization failed: ".concat(error_1));
