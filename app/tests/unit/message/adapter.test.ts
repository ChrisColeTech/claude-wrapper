...
describe('MessageAdapter', () => {
  describe('messagesToPrompt', () => {
    ...
    describe('Edge cases and special content', () => {
      it('should handle messages with newlines', () => {
        ...
        expect(result.prompt).toContain("Assistant: Response line 1\nResponse line 2");
      });
      ...
      it('should handle messages with special characters', () => {
        ...
        expect(result.prompt).toContain('Human: Message with "quotes" and <tags>');
        expect(result.prompt).toContain("Assistant: Response with symbols: @#$%^&*()");
      });
  ...
  describe('validateMessageFlow', () => {
    ...
    it('should reject only system messages', () => {
      const messages = [
        MessageHelpers.system("System instruction")
      ];
  ...
  describe('Integration scenarios', () => {
    it('should handle realistic chat conversation', () => {
      const messages = [
        MessageHelpers.system("You are a helpful AI assistant. Be concise and accurate."),
        MessageHelpers.user("Can you help me understand what TypeScript is?"),
        MessageHelpers.assistant("TypeScript is a programming language developed by Microsoft. It's a superset of JavaScript that adds static type checking."),
        MessageHelpers.user("What are the main benefits?"),
        MessageHelpers.assistant("The main benefits include: better error detection, improved IDE support, easier refactoring, and enhanced code documentation."),
        MessageHelpers.user("Thanks! Can you give me a simple example?")
      ];
      
      const result = MessageAdapter.messagesToPrompt(messages);
      
      expect(result.systemPrompt).toBe("You are a helpful AI assistant. Be concise and accurate.");
      expect(result.prompt).toContain("Human: Can you help me understand what TypeScript is?");
      expect(result.prompt).toContain("Assistant: TypeScript is a programming language");
      ...
      expect(result.prompt).toContain("Human: Thanks! Can you give me a simple example?");
    ...
    it('should work with multimodal content (converted to string)', () => {
      const messages = [
        ...
        MessageHelpers.assistant("I can see the content, but image analysis is not available in this context.")
      ];
